...
export const FilterLabel: React.FC = () => {
  ...
  return (
    <Label>
      ...
      <FilterWrapper>
        <FilterButton selected={Filter === ActiveStatus.ALL} onClick={() => filterByActivity(ActiveStatus.ALL)}>Wszyscy</FilterButton>
        <FilterButton selected={Filter === ActiveStatus.ACTIVE} onClick={() => filterByActivity(ActiveStatus.ACTIVE)}>Aktywni</FilterButton>
        <FilterButton selected={Filter === ActiveStatus.INACTIVE} onClick={() => filterByActivity(ActiveStatus.INACTIVE)}>Nieaktywni</FilterButton>
      </FilterWrapper>
    </Label>
  )
}
