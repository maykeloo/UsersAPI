...
import { ListContent, ListWrapper, NotFoundWrapper } from "./UserList.styles";
    ...
    <>
      <ListContent>
        ...
        <ListWrapper>
          ...
          {
            users && users.length === 0 && <NotFoundWrapper><h2>Nie znaleziono użytkowników...</h2></NotFoundWrapper> 
          }
        </ListWrapper>
        <PaginationWrapper>
          <PaginationOutlined />
